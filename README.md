...
```shell
docker run -p8080:80 -e REMOTE_URI=https://example.com:443 mgerasimchuk/protty:v0.4.8
```
...
```
» ~  docker run -p8080:80 -it mgerasimchuk/protty:v0.4.8 /bin/sh -c 'protty start --help'  
Start the proxy
